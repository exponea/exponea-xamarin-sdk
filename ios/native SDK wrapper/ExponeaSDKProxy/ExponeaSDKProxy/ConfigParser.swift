...
class ConfigurationParser {
    ...
    func parsePushNotificationTracking() throws -> ExponeaSDK.Exponea.PushNotificationTracking {
        let appGroup = try dictionary.getOptionalSafely(property: "appGroup") ?? ""
        ...
        let requirePushAuthorization = try dictionary.getOptionalSafely(property: "requirePushAuthorization") ?? true
    ...
    func parseAllowDefaultCustomerProperties() throws -> Bool? {
        return try dictionary.getOptionalSafely(property: "allowDefaultCustomerProperties")
    }
